...
->何もしない(elo:0)<br>
->ビーム幅1、評価関数なし(elo:360)<br>
->ビーム幅1、評価関数あり(elo:871)<br>
->ビーム幅10、評価関数あり(elo:1507)<br>
->ビーム幅100、評価関数あり(elo:1957)<br>
->ビーム幅1000、評価関数あり(elo:2381)<br>
->ビーム幅10000、評価関数あり(elo:2762)<br>
->ビーム幅28000、評価関数あり(elo:2917)<br>
->ビーム幅2800000、評価関数あり(elo:3217)<br>
->ビームスタックサーチ(elo:3728)<br>
...
| --- | --- | --- | --- |
| Fire.cpp | Intel(R) Core(TM) i5-8250U | 0.2501s | 8.0089/8.0089 |
| Fire.cpp | Intel(R) Core(TM) i5-11400 | 0.1090s | 7.9936/7.9936 |
| FireII.cpp | Intel(R) Core(TM) i5-8250U| 0.1530s | 7.9964/7.9964 |
| FireII.cpp | Intel(R) Core(TM) i5-11400| 0.0843s | 7.9969/7.9969 |
